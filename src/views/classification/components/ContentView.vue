<template>
  <div class="wrapper">
    ...
    <div class="subTitleWrapper"
      ...
      <ul ref="ulContent">
        <li class="title"
            ...
            v-for="(detailItem,index) in classificationData"
            :key="detailItem.id"
            ref="subTitle"
    ...
    <section class="r_list"
             ref="r_list">
      <div ref="b">
        <div v-for="(it,index) in classificationData"
             :key="index"
             ref="good">
            ...
            <li v-for="(item,index) in it.skus"
              ...
              <div class="list_item flex">
                ...
                <div>
                  ...
                  <p class="price">{{item.discountAmount | moneyFormat}}</p>
                  <p class="originPrice">{{item.skuAmount | moneyFormat}}</p>
